	...
	<div id="top" style="width: <?php echo $SETW ?>">
		...
		<table style="text-align: center;">
			...
			<tr>
				...
				<td><input type="hidden" title="Show Name" name="shname" maxlength="90" readonly value="<?php echo $SHOW; ?>"/>
					...
					?>"</select></td>
				<td><input type="test" required title="Station Name" maxlength="5" size="5" name="shstat" readonly value="<?php echo $CALL; ?>"/></td>
				...
				<td><input type="number" title="Total Calcualted Time Spoken" name="shspkn" value="00" readonly/></td>
				<td><input type="text" title="Specifies if program is finalized" value="<?php echo $FINAL; ?>" readonly/></td>
			</tr>
		</table>
	</div>
			...
			<tr>
				<td>
					<input name="changed" value="true" hidden="true" />
						<input type="text" hidden="true" name="changed" value="TRUE"/>
						<input type="text" hidden="true" name="callsign" value=<?php echo "\"" . $CALL . "\"" ?> />
	            		<input type="text" hidden="true" name="program" value=<?php echo "\"" . stripslashes($SHOW) . "\"" ?> />
	            		<input type="text" hidden="true" name="user_date" value=<?php echo "\"" . $DATE . "\"" ?> />
	            		<input type="text" hidden="true" name="user_time" value=<?php echo "\"" . $START . "\"" ?> />
					<input type="submit" value="Submit Changes"></form></td><td>
					<form action="/episode/p2insertEP.php" method="POST">
						<input type="text" hidden="true" name="callsign" value=<?php echo "\"" . $CALL . "\"" ?> />
	            		<input type="text" hidden="true" name="program" value=<?php echo "\"" . stripslashes($SHOW) . "\"" ?> />
	            		<input type="text" hidden="true" name="user_date" value=<?php echo "\"" . $DATE . "\"" ?> />
	            		<input type="text" hidden="true" name="user_time" value=<?php echo "\"" . $START . "\"" ?> />
