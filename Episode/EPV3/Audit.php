...
<html style="height: 100%;" lang="en">
	...
	<body style="height: inherit;">
		<div id="content" style="margin: auto; width: 1280px; height: inherit; background-color: white;">
			...
			<div id="logo" style="margin-bottom: 25px;"><img style="display: inline;" src="/images/ckxu_logo_PNG.png" alt="logo"/><h1 style="display: inline; text-align: center; width: 100%">
			...
			<div id="CustRep" style="margin-top: 100px;">
				<div id="CRO">
					...
					<div id="radio" style="float: left">
						<h3>Time Format</h3>
						<input type="radio" id="time12" name="timef" value="12"/><label for="time12">12 Hour</label>
					...
					<div id="opts" style="float: left; margin-left: 20px">
						...
						<input type="checkbox" name="ple" id="pl" title="Include Playlist Numbers"/><label for="pl">Playlist</label>
						...
						<input type="checkbox" name="sls" id="sls" title="Generate individual Log Statistics"/><label for="sls">Show Stats</label>
						<input type="checkbox" name="rps" id="rps" title="Include Statistics overview for report timeframe"/><label for="rps">Statistics</label>
					</div>
			...
			<div id="CustRep" style="margin-top: 100px;">
				<div id="CRO">
					...
					<div id="prt_opts" style="float: left; margin-left: 20px">
						<h3>Audit Type</h3>
						<input type="radio" name="type" id="COT" title="Include Playlist Numbers"/><label for="COT">Commercial Only</label>
						<input type="radio" name="type" id="MOT" title="Create a barcoded EAN13 Report"/><label for="MOT">Music Only</label>
						<input type="radio" name="type" id="SOT" title="Place a page break after each log"/><label for="SOT">Spoken Only</label>
