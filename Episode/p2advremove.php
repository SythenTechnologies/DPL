...
if (!$con){
	...
	$result = mysql_query($SQLA) or die(mysql_error());
		...
		/*echo "<form name=\"row\" action=\"/program/p3advupdate.php\" method=\"POST\"><tr>
				<td>";*/
		echo "<form name=\"row\" action=\"/Episode/VEREM.php\" method=\"POST\"><tr>
				<td>";
...
?>
	...
	<div id="foot">
		<table>
			<tr>
				<td>
					<form action="/Episode/p1advremove.php" method="POST">
				<input type="submit" value="Return to Search"/></form></td><td>
					<form action="/program/p1update.php" method="POST"></form>
