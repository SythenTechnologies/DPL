...
<body>
	...
	<h2>View Program Log</h2>
        ...
        <td>
        <form name="edit" action="/Episode/p3update.php" method="POST">
        ...
        <td>
        <form name="verify" action="/episode/p3advremove.php" method="POST">
        <input type="text" hidden="true" name="callsign" value=<?php echo "\"" . $PROGRAMARRAY['callsign'] . "\"" ?> />
            <input type="text" hidden="true" name="program" value=<?php echo "\"" . $_POST['program'] . "\"" ?> />
            <input type="text" hidden="true" name="date" value=<?php echo "\"" . $_POST['user_date'] . "\"" ?> />
            <input type="text" hidden="true" name="time" value=<?php echo "\"" . $_POST['user_time'] . "\"" ?> />
