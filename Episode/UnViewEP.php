...
<body>
	...
	function viewExport(){
		...
		echo "\"/Episode/ExportView.php?args=".addslashes($_POST['program'])."@".addslashes($_POST['user_date'])."@".addslashes($_POST['user_time'])."@".addslashes($CALLSHOW)."\"" ?>,'name','height=800,width=800');
